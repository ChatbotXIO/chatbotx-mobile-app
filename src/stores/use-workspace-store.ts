 ...
 *
 * `currentWorkspaceId` mirrors the bigint-as-string id convention — ids are bigint-as-string
 * throughout the API. Persisted so the app reopens on the last-selected workspace instead of
 * forcing the picker every launch.
 */
